...
const Coach = () => {
  ...
  return (
    <main className="min-h-[100dvh] bg-background relative overflow-x-hidden">
      ...
      {/* Background motion */}
      <div className="absolute top-[8%] right-[-5%] w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-primary/5 rounded-full blur-[150px] animate-float opacity-30 pointer-events-none" />
      <div className="absolute bottom-[20%] left-[-10%] w-[250px] md:w-[500px] h-[250px] md:h-[500px] bg-accent/5 rounded-full blur-[130px] animate-float opacity-20 pointer-events-none" style={{ animationDelay: "-4s" }} />

      <div className="container relative z-10 pt-20 md:pt-32 pb-32 lg:pb-20">
        ...
        <div className="flex items-start justify-between gap-4 mb-8 md:mb-12">
          <div className="space-y-3">
            ...
            <h1 className="speak-serif text-3xl md:text-5xl lg:text-6xl leading-[0.9] tracking-tighter">

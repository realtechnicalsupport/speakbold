...
{!dismissedTips.has("filler") && (
        <CommonMistake onDismiss={() => setDismissedTips(prev => new Set([...prev, "filler"]))}>
...
{!dismissedTips.has("pause") && (
            <CommonMistake onDismiss={() => setDismissedTips(prev => new Set([...prev, "pause"]))}>
